...
export default function Home() {
  return (
    <>
      <title>Home - Gabriel Gavrilov</title>
      <div className="w-full min-h-screen h-full flex items-center justify-center">
        <div className="flex flex-col items-center justify-center">
          <Profile large={true} />
          <h2 className="text-3xl mt-6 mb-1 font-semibold">Gabriel Gavrilov</h2>
          <h3 className="text-2xl font-semibold">Software | DevOps</h3>
          <div className="flex mt-6 items-center">
            <a href="https://github.com/gabrielgavrilov" target="_blank">
              <svg
                width="42px"
                height="42px"
                viewBox="0 0 16 16"
            ...
            <a
              href="https://www.linkedin.com/in/gabriel-gavrilov/"
              target="_blank"
            >
              <svg
                width="48px"
